...
!function(t, n) {
    ...
    function Y(t, n) {
        ...
        function l(l) {
            ...
            A = A.merge(M.append("text").attr("fill", "currentColor").attr(f, c * p).attr("dy", t === z ? "0em" : t === D ? "0.71em" : "0.32em")),
    ...
    function zn(t) {
        if (t instanceof Dn)
            return new Dn(t.l,t.a,t.b,t.opacity);
        if (t instanceof Fn)
            return In(t);
        t instanceof yn || (t = vn(t));
        var n, e, r = On(t.r), i = On(t.g), o = On(t.b), a = qn((.2225045 * r + .7168786 * i + .0606169 * o) / Tn);
        return r === i && i === o ? n = e = a : (n = qn((.4360747 * r + .3850649 * i + .1430804 * o) / An),
        e = qn((.0139322 * r + .0971045 * i + .7141733 * o) / Sn)),
    ...
    function In(t) {
        if (isNaN(t.h))
            return new Dn(t.l,0,0,t.opacity);
        var n = t.h * Mn;
    ...
    function Qn(t, n, e, r) {
        return 1 === arguments.length ? function(t) {
            if (t instanceof Jn)
                return new Jn(t.h,t.s,t.l,t.opacity);
            t instanceof yn || (t = vn(t));
            var n = t.r / 255
              , e = t.g / 255
              , r = t.b / 255
    ...
    function _e(t, n) {
        var e, r = typeof n;
        return null == n || "boolean" === r ? ee(n) : ("number" === r ? de : "string" === r ? (e = hn(n)) ? (n = e,
        ue) : ye : n instanceof hn ? ue : n instanceof Date ? he : Array.isArray(n) ? le : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? pe : de)(t, n)
    }
    function be(t, n) {
        return n -= t = +t,
        function(e) {
    ...
    var me, xe, we, Me, Ne = 180 / Math.PI, Ae = {
        translateX: 0,
        translateY: 0,
        rotate: 0,
        skewX: 0,
    ...
    var ke = Se(function(t) {
        return "none" === t ? Ae : (me || (me = document.createElement("DIV"),
        xe = document.documentElement,
        we = document.defaultView),
        me.style.transform = t,
        t = we.getComputedStyle(xe.appendChild(me), null).getPropertyValue("transform"),
        xe.removeChild(me),
        Te(+(t = t.slice(7, -1).split(","))[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
    }, "px, ", "px)", "deg)")
      , Ee = Se(function(t) {
        return null == t ? Ae : (Me || (Me = document.createElementNS("http://www.w3.org/2000/svg", "g")),
        Me.setAttribute("transform", t),
        (t = Me.transform.baseVal.consolidate()) ? Te((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : Ae)
    }, ", ", ")", ")")
      , Ce = Math.SQRT2
      , Pe = 2
      , ze = 4
    ...
    function qe(t, n) {
        ...
        if (h < Re)
            ...
            r = (y - g) / Ce,
            e = function(t) {
                var n, e = t * r, u = De(g), c = a / (Pe * d) * (u * (n = Ce * e + g,
    ...
    function ar() {
        ...
        ++Ve;
        for (var t, n = Xe; n; )
            (t = Je - n._time) >= 0 && n._call.call(null, t),
            n = n._next;
        --Ve
    }
    function ur() {
    ...
    function fr(t) {
        Ve || ($e && ($e = clearTimeout($e)),
        t - Je > 24 ? (t < 1 / 0 && ($e = setTimeout(ur, t - tr.now() - Ke)),
        We && (We = clearInterval(We))) : (We || (Qe = tr.now(),
        We = setInterval(cr, Ze)),
        Ve = 1,
        nr(ur)))
    }
    function sr(t, n, e) {
    ...
    ir.prototype = or.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            this._next || Ge === this || (Ge ? Ge._next = this : Xe = this,
            Ge = this),
            this._call = t,
            this._time = e,
            fr()
        ...
        !function(t, n, e) {
            ...
            function a(n) {
                ...
                1), o = -1, a = r.length; ++o < a; )
                    r[o].call(t, i);
                e.state === _r && (e.on.call("end", t, t.__data__, e.index, e.group),
                u())
            }
            function u() {
                for (var r in e.state = br,
                e.timer.stop(),
                delete i[n],
                i)
                    return;
    ...
    function Nr(t, n) {
        ...
        if (o) {
            ...
            o)
                (e = o[i]).name === n ? (r = e.state > vr && e.state < _r,
                e.state = br,
                e.timer.stop(),
    ...
    function Tr(t, n) {
        var e;
        return ("number" == typeof n ? de : n instanceof hn ? ue : (e = hn(n)) ? (n = e,
        ue) : ye)(t, n)
    }
    ...
    function zi(n) {
        ...
        function l() {
            ...
            if (i.apply(this, arguments)) {
                ...
                "overlay" === m ? N.selection = T = [[r = n === mi ? S : z[0], a = n === bi ? k : z[1]], [s = n === mi ? E : r, h = n === bi ? C : a]] : (r = T[0][0],
                a = T[0][1],
                s = T[1][0],
                h = T[1][1]),
                o = r,
                ...
                if (t.event.touches)
                    ...
                    var U = zt(t.event.view).on("keydown.brush", function() {
                        ...
                        case 16:
                            ...
                            break;
                        case 18:
                            x === _i && (w < 0 ? s = l : w > 0 && (r = o),
                            M < 0 ? h = d : M > 0 && (a = u),
                            x = yi,
                            B());
                            break;
                        case 32:
                            x === gi && (t.event.altKey ? (w && (s = l - p * w,
                            r = o + p * w),
                            M && (h = d - v * M,
                            a = u + v * M),
                            x = _i) : (w < 0 ? s = l : w > 0 && (r = o),
            ...
            function B() {
                ...
                case gi:
                case vi:
                    w && (p = Math.max(S - r, Math.min(E - s, p)),
                    o = r + p,
                    l = s + p),
                    M && (v = Math.max(k - a, Math.min(C - h, v)),
                    u = a + v,
                    d = h + v);
                    break;
                case yi:
                    ...
                    o = r + p,
                    l = s) : w > 0 && (p = Math.max(S - s, Math.min(E - s, p)),
                    o = r,
                    l = s + p),
                    M < 0 ? (v = Math.max(k - a, Math.min(C - a, v)),
                    u = a + v,
                    d = h) : M > 0 && (v = Math.max(k - h, Math.min(C - h, v)),
                    u = a,
                    d = h + v);
                    break;
                case _i:
                    ...
                    M && (u = Math.max(k, Math.min(C, a - v * M)),
                ...
                _ && (u = T[0][1],
                d = T[1][1]),
                T[0][0] === o && T[0][1] === u && T[1][0] === l && T[1][1] === d || (N.selection = [[o, u], [l, d]],
                c.call(b),
                D.brush())
            }
            function Y() {
        ...
        u.extent = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : li([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            u) : r
        }
        ,
        u.filter = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : li(!!t),
            u) : i
        }
        ,
    ...
    Hi.prototype = Xi.prototype = {
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            e && (l < 0 && (l = l % Ii + Ii),
            l > ji ? this._ += "A" + e + "," + e + ",0,1," + s + "," + (t - a) + "," + (n - u) + "A" + e + "," + e + ",0,1," + s + "," + (this._x1 = c) + "," + (this._y1 = f) : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(l >= Fi) + "," + s + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
        },
    ...
    function vo() {
        ...
        i.thresholds = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Array.isArray(t) ? co(ao.call(t)) : co(t),
            i) : e
        }
        ,
        i.smooth = function(t) {
            return arguments.length ? (r = t ? u : ho,
            i) : r === u
        }
        ,
        i
    ...
    function Co(t) {
        ...
        function r(t, n) {
            ...
            function s() {
                ...
                if (t.charCodeAt(i) === Mo) {
                    for (; a++ < o && t.charCodeAt(a) !== Mo || t.charCodeAt(++a) === Mo; )
                        ;
                    return (n = a) >= o ? c = !0 : (r = t.charCodeAt(a++)) === No ? f = !0 : r === Ao && (f = !0,
                    t.charCodeAt(a) === No && ++a),
            ...
            for (t.charCodeAt(o - 1) === No && --o,
            t.charCodeAt(o - 1) === Ao && --o; (r = s()) !== wo; ) {
                for (var l = []; r !== xo && r !== wo; )
                    l.push(r),
                    r = s();
        ...
        e *= e); c = p.pop(); )
            if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l))
                if (v.length) {
                    var g = (i + a) / 2
                      , y = (o + u) / 2;
                    p.push(new ia(v[3],g,y,a,u), new ia(v[2],i,y,g,u), new ia(v[1],g,o,a,y), new ia(v[0],i,o,g,y)),
    ...
    sa.visit = function(t) {
        ...
        for (c && u.push(new ia(c,this._x0,this._y0,this._x1,this._y1)); n = u.pop(); )
    ...
    var Du, qu, Lu, Uu, Ou, Bu, Yu, Fu, Iu, ju, Hu, Xu, Gu, Vu, $u, Wu, Zu, Qu, Ju, Ku, tc, nc, ec, rc, ic, oc, ac = qa(), uc = {
        ...
        polygonEnd: function() {
            ...
            uc.lineEnd = lc,
            mu < 0 ? (Du = -(Lu = 180),
            qu = -(Uu = 90)) : ac > Ba ? Uu = 90 : ac < -Ba && (qu = -90),
            ju[0] = Du,
            ju[1] = Lu
        },
        sphere: function() {
    ...
    function fc(t, n) {
        ...
        if (Fu) {
            ...
            f ^ (u * Ou < c && c < u * t) ? (o = i[1] * Xa) > Uu && (Uu = o) : f ^ (u * Ou < (c = (c + 360) % 360 - 180) && c < u * t) ? (o = -i[1] * Xa) < qu && (qu = o) : (n < qu && (qu = n),
            n > Uu && (Uu = n)),
            f ? t < Ou ? vc(Du, t) > vc(Du, Lu) && (Lu = t) : vc(t, Lu) > vc(Du, Lu) && (Du = t) : Lu >= Du ? (t < Du && (Du = t),
            t > Lu && (Lu = t)) : t > Ou ? vc(Du, t) > vc(Du, Lu) && (Lu = t) : vc(t, Lu) > vc(Du, Lu) && (Du = t)
        } else
            Iu.push(ju = [Du = t, Lu = t]);
        n < qu && (qu = n),
        n > Uu && (Uu = n),
    ...
    function Lc(t) {
        function n(n) {
            return (n = t(n[0] * Ga, n[1] * Ga))[0] *= Xa,
            n[1] *= Xa,
            n
        }
        return t = zc(t[0] * Ga, t[1] * Ga, t.length > 2 ? t[2] * Ga : 0),
        n.invert = function(n) {
            return (n = t.invert(n[0] * Ga, n[1] * Ga))[0] *= Xa,
            n[1] *= Xa,
            n
        }
        ,
    ...
    function Gc(t, n) {
        var e = Xc(n)
          ...
          , u = 0;
        Hc.reset(),
        1 === i ? r = Ia + Ba : -1 === i && (r = -Ia - Ba);
        for (var c = 0, f = t.length; c < f; ++c)
            if (l = (s = t[c]).length)
                for (var s, l, h = s[l - 1], d = Xc(h), p = h[1] / 2 + ja, v = nu(p), g = Za(p), y = 0; y < l; ++y,
                d = b,
                v = x,
                g = w,
                h = _) {
                    var _ = s[y]
                      ...
                      , T = A > Fa
                      , S = v * x;
                    if (Hc.add(Wa(S * N * nu(A), g * w + S * Za(A))),
                    a += T ? M + N * Ha : M,
                    T ^ d >= e ^ b >= e) {
                        var k = Cu(ku(h), ku(_));
                        Ru(k);
        ...
        return function(i) {
            var o, a, u, c = n(i), f = Bc(), s = n(f), l = !1, h = {
                ...
                polygonEnd: function() {
                    ...
                    l = !0),
                    Ic(a, Wc, t, e, i)) : t && (l || (i.polygonStart(),
                    l = !0),
                    i.lineStart(),
                    e(null, null, 1, i),
                    i.lineEnd()),
    ...
    var Zc = Vc(function() {
        ...
        return {
            ...
            point: function(o, a) {
                var u = o > 0 ? Fa : -Fa
                  , c = Va(o - e);
                Va(c - Fa) < Ba ? (t.point(e, r = (r + a) / 2 > 0 ? Ia : -Ia),
                t.point(i, r),
                t.lineEnd(),
                t.lineStart(),
                t.point(u, r),
                t.point(o, r),
                n = 0) : i !== u && c >= Fa && (Va(e - i) < Ba && (e -= i * Ba),
                Va(o - u) < Ba && (o -= u * Ba),
                r = function(t, n, e, r) {
                    var i, o, a = nu(t - e);
    ...
    function Qc(t) {
        ...
        function a(t, e, r) {
            ...
            if (!(g < 0)) {
                ...
                w = M,
                M = b),
                A || N < Ba ? A ? w + M > 0 ^ _[1] < (Va(_[0] - m) < Ba ? w : M) : w <= _[1] && _[1] <= M : N > Fa ^ (m <= _[0] && _[0] <= x)) {
                    var T = zu(d, (-p + y) / v);
                    return Pu(T, h),
                    [_, Su(T)]
                }
        ...
        return Vc(o, function(t) {
            ...
            return {
                ...
                point: function(l, h) {
                    ...
                    v !== c && (!(d = a(n, p)) || Yc(n, d) || Yc(p, d)) && (p[0] += Ba,
                    p[1] += Ba,
                    v = o(p[0], p[1])),
                    v !== c)
                        s = 0,
    ...
    var If, jf, Hf, Xf, Gf = 0, Vf = 0, $f = 0, Wf = 0, Zf = 0, Qf = 0, Jf = 0, Kf = 0, ts = 0, ns = {
        ...
        result: function() {
            ...
            return Gf = Vf = $f = Wf = Zf = Qf = Jf = Kf = ts = 0,
            t
        }
    };
    function es(t, n) {
        ...
        return +n ? function(t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                ...
                if (b > 4 * n && v--) {
                    var m = a + h
                      ...
                      , C = k - i
                      , P = _ * E - y * C;
                    (P * P / b > n || Va((y * E + _ * C) / b - .5) > .3 || a * h + u * d + c * p < Ps) && (e(r, i, o, a, u, c, S, k, A, m /= M, x /= M, w, v, g),
                    g.point(S, k),
            ...
            return function(n) {
                ...
                function _(r, i) {
                    var o = ku([r, i])
                      , a = t(r, i);
                    e(s, l, f, h, d, p, s = a[0], l = a[1], f = r, h = o[0], d = o[1], p = o[2], Cs, n),
                    n.point(s, l)
                }
                function b() {
                    v.point = g,
    ...
    function Ls(t) {
        ...
        A.clipAngle = function(t) {
            return arguments.length ? (x = +t ? Qc(m = t * Ga) : (m = null,
            Zc),
            k()) : m * Xa
        }
        ,
        A.clipExtent = function(t) {
            ...
            Af) : tf(w = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]),
        ...
        ,
        A.center = function(t) {
            return arguments.length ? (p = t[0] % 360 * Ga,
            v = t[1] % 360 * Ga,
            S()) : [p * Xa, v * Xa]
        }
        ,
        A.rotate = function(t) {
            return arguments.length ? (g = t[0] % 360 * Ga,
            y = t[1] % 360 * Ga,
        ...
        ,
        A.angle = function(t) {
            return arguments.length ? (b = t % 360 * Ga,
            S()) : b * Xa
        }
        ,
        A.precision = function(t) {
            return arguments.length ? (a = zs(u, N = t * t),
            k()) : ru(N)
        }
        ,
    ...
    el.invert = function(t, n) {
        for (var e, r = n, i = r * r, o = i * i * i, a = 0; a < 12 && (o = (i = (r -= e = (r * (Qs + Js * i + o * (Ks + tl * i)) - n) / (Qs + 3 * Js * i + o * (7 * Ks + 9 * tl * i))) * r) * i * i,
        !(Va(e) < Ya)); ++a)
            ;
    ...
    ol.invert = function(t, n) {
        ...
        } while (Va(e) > Ba && --i > 0);return [t / (.8707 + (o = r * r) * (o * (o * o * o * (.003971 - .001529 * o) - .013791) - .131979)), r]
    }
    ,
    al.invert = Is(au),
    ...
    function bl(t) {
        for (var n, e, r = 0, i = (t = function(t) {
            for (var n, e, r = t.length; r; )
                ...
                t[e] = n;
            return t
        }(_l.call(t))).length, o = []; r < i; )
            n = t[r],
            e && wl(e, n) ? ++r : (e = Nl(o = ml(o, n)),
            r = 0);
        return e
    }
    function ml(t, n) {
    ...
    function th(t, n, e, r, i, o) {
        for (var a, u, c, f, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
            ...
            a.dice ? Yl(a, e, r, i, w ? r += f * s / w : o) : Jl(a, e, r, w ? e += c * s / w : i, o),
            w -= s,
            b = m
        }
        return y
        ...
        function e(t, e, r, i, o) {
            if ((a = t._squarify) && a.ratio === n)
                for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
                    ...
                    s = c.length; f < s; ++f)
                        u.value += c[f].value;
                    u.dice ? Yl(u, e, r, i, r += (o - r) * u.value / d) : Jl(u, e, r, e += (i - e) * u.value / d, o),
                    d -= u.value
                }
            else
                t._squarify = a = th(n, t, e, r, i, o),
                a.ratio = n
        }
        return e.ratio = function(n) {
            return t((n = +n) > 1 ? n : 1)
    ...
    function _h() {
        ...
        ,
        i.range = function(t) {
            return arguments.length ? (e = gh.call(t),
            i) : e.slice()
        }
        ,
    ...
    function kh() {
        ...
        function s() {
            return r = Math.min(a.length, u.length) > 2 ? Th : Ah,
            i = o = null,
            l
        }
        function l(n) {
        ...
        ,
        l.domain = function(t) {
            return arguments.length ? (a = vh.call(t, mh),
            f === wh || (f = Nh(a)),
            s()) : a.slice()
        }
        ,
        l.range = function(t) {
            return arguments.length ? (u = gh.call(t),
            s()) : u.slice()
        }
        ,
        ...
        ,
        l.clamp = function(t) {
            return arguments.length ? (f = t ? Nh(a) : wh,
            l) : f !== wh
        }
        ,
    ...
    function Ch(n, e, r, i) {
        ...
        case "s":
            ...
            return null != i.precision || isNaN(o = Ra(a, u)) || (i.precision = o),
            t.formatPrefix(i, u);
        case "":
        case "e":
        case "g":
    ...
    Qh.every = function(t) {
        return t = Math.floor(t),
        isFinite(t) && t > 0 ? t > 1 ? Zh(function(n) {
        ...
        function w(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f; )
                    ...
                    null != (i = ip[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0",
                    (o = n[r]) && (r = o(e, i)),
                    a.push(r),
                    c = u + 1);
            ...
            return function(e) {
                ...
                "V"in o) {
                    if (o.V < 1 || o.V > 53)
                        return null;
                    "w"in o || (o.w = 1),
                    "Z"in o ? (i = (r = tp(np(o.y))).getUTCDay(),
                    r = i > 4 || 0 === i ? Ld.ceil(r) : Ld(r),
                    r = zd.offset(r, 7 * (o.V - 1)),
                    o.y = r.getUTCFullYear(),
                    o.m = r.getUTCMonth(),
                    o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = n(np(o.y))).getDay(),
                    r = i > 4 || 0 === i ? ld.ceil(r) : ld(r),
    ...
    function ov(t, n) {
        var e = t.getUTCDay();
        return t = e >= 4 || 0 === e ? Bd(t) : Bd.ceil(t),
    ...
    function Ny() {
        ...
        return a.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : ny(+n),
            a) : t
        }
        ,
        a.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : ny(+t),
            a) : n
        }
        ,
        a.defined = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : ny(!!t),
            a) : e
        }
        ,
        a.curve = function(t) {
    ...
    function Ay() {
        ...
        return c.x = function(e) {
            return arguments.length ? (t = "function" == typeof e ? e : ny(+e),
            n = null,
            c) : t
        }
        ,
        ...
        ,
        c.x1 = function(t) {
            return arguments.length ? (n = null == t ? null : "function" == typeof t ? t : ny(+t),
            c) : n
        }
        ,
        c.y = function(t) {
        ...
        ,
        c.y1 = function(t) {
            return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : ny(+t),
            c) : r
        }
        ,
        ...
        c.defined = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : ny(!!t),
            c) : i
        }
        ,
        c.curve = function(t) {
    ...
    function Oy(t) {
        ...
        ,
        a.x = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : ny(+t),
            a) : r
        }
        ,
        a.y = function(t) {
    ...
    var Iy = {
      ...
      , r_ = {
        draw: function(t, n) {
            ...
            t.lineTo(o, a),
            t.lineTo(u, c),
            t.lineTo(-.5 * r - t_ * i, t_ * r + -.5 * i),
            t.lineTo(-.5 * o - t_ * a, t_ * o + -.5 * a),
            t.lineTo(-.5 * u - t_ * c, t_ * u + -.5 * c),
            t.lineTo(-.5 * r + t_ * i, -.5 * i - t_ * r),
            t.lineTo(-.5 * o + t_ * a, -.5 * a - t_ * o),
            t.lineTo(-.5 * u + t_ * c, -.5 * c - t_ * u),
            t.closePath()
        }
    }
        ...
        lineEnd: function() {
            ...
            if (e)
                ...
                2 === e)
                    ...
                    for (var r = q_(t), i = q_(n), o = 0, a = 1; a < e; ++o,
                    ++a)
    ...
    function vb(t) {
        var n = t.circle
          ...
          , u = [t];
        pb(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < Mb && Math.abs(r - c.circle.cy) < Mb; )
            o = c.P,
            u.unshift(c),
            pb(c),
            c = o;
        u.unshift(c),
        sb(c);
        for (var f = a; f.circle && Math.abs(e - f.circle.x) < Mb && Math.abs(r - f.circle.cy) < Mb; )
            a = f.N,
            u.push(f),
            pb(f),
            f = a;
        ...
        n) {
            ...
            !function(t, n, e, r) {
                for (var i, o = wb.length; o--; )
                    eb(i = wb[o], t, n, e, r) && nb(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > Mb || Math.abs(i[0][1] - i[1][1]) > Mb) || delete wb[o]
            }(a, u, c, f),
            function(t, n, e, r) {
                ...
                for (i = 0; i < g; ++i)
                    if (o = mb[i]) {
                        ...
                        f = c.length; u < f; )
                            ...
                            l = (s = ib(o, wb[c[++u % f]]))[0],
                            h = s[1],
                            (Math.abs(p - l) > Mb || Math.abs(v - h) > Mb) && (c.splice(u, 0, wb.push(K_(a, d, Math.abs(p - t) < Mb && r - v > Mb ? [t, Math.abs(l - t) < Mb ? h : r] : Math.abs(v - r) < Mb && e - p > Mb ? [Math.abs(h - r) < Mb ? l : e, r] : Math.abs(p - e) < Mb && v - n > Mb ? [e, Math.abs(l - e) < Mb ? h : n] : Math.abs(v - n) < Mb && p - t > Mb ? [Math.abs(h - n) < Mb ? l : t, n] : null)) - 1),
                            ++f);
                        f && (y = !1)
                    }
                if (y) {
                    ...
                    for (i = 0,
                    y = null; i < g; ++i)
                        (o = mb[i]) && (m = (_ = (a = o.site)[0] - t) * _ + (b = a[1] - n) * b) < x && (x = m,
                        y = o);
                    if (y) {
                        var w = [t, n]
                          , M = [t, r]
    ...
    t.chord = function() {
        ...
        return i.padAngle = function(n) {
            return arguments.length ? (t = Oi(0, n),
            i) : t
        }
        ,
    ...
    t.ribbon = function() {
        var t = Gi
          ...
          , o = null;
        function a() {
            var a, u = Bi.call(arguments), c = t.apply(this, u), f = n.apply(this, u), s = +e.apply(this, (u[0] = c,
            u)), l = r.apply(this, u) - Li, h = i.apply(this, u) - Li, d = s * Ri(l), p = s * Di(l), v = +e.apply(this, (u[0] = f,
            u)), g = r.apply(this, u) - Li, y = i.apply(this, u) - Li;
            if (o || (o = a = Xi()),
            o.moveTo(d, p),
            o.arc(0, 0, s, l, h),
            l === g && h === y || (o.quadraticCurveTo(0, 0, v * Ri(g), v * Di(g)),
            o.arc(0, 0, v, g, y)),
    ...
    t.nest = function() {
        ...
        function o(e, i, a, u) {
            if (i >= r.length)
                ...
                null != n ? n(e) : e;
            for (var c, f, s, l = -1, h = e.length, d = r[i++], p = Ji(), v = a(); ++l < h; )
    ...
    t.contourDensity = function() {
        ...
        l.thresholds = function(t) {
            return arguments.length ? (s = "function" == typeof t ? t : Array.isArray(t) ? co(ao.call(t)) : co(t),
            l) : s
        }
        ,
    ...
    t.drag = function() {
        ...
        function y() {
            if (o.apply(this, arguments)) {
                ...
                for (n = 0; n < u; ++n)
                    (e = m(r[n].identifier, i, Bt, this, arguments)) && (Yt(),
                    e("start"))
            }
        }
        function _() {
    ...
    t.forceCollide = function(t) {
        ...
        return "function" != typeof t && (t = na(null == t ? 1 : +t)),
    ...
    t.forceLink = function(t) {
        ...
        s.strength = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : na(+t),
            h(),
            s) : u
        }
        ,
        s.distance = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : na(+t),
            d(),
            s) : c
        }
        ,
    ...
    t.forceManyBody = function() {
        ...
        c.strength = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : na(+t),
            f(),
            c) : i
        }
        ,
    ...
    t.forceRadial = function(t, n, e) {
        ...
        return "function" != typeof t && (t = na(+t)),
        null == n && (n = 0),
        null == e && (e = 0),
        ...
        u.strength = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : na(+t),
            c(),
            u) : a
        }
        ,
    ...
    t.forceX = function(t) {
        ...
        return "function" != typeof t && (t = na(null == t ? 0 : +t)),
        o.initialize = function(t) {
            n = t,
            a()
        }
    ...
    t.geoBounds = function(t) {
        ...
        e = Iu.length) {
            ...
            n = 1,
            o = [r = Iu[0]]; n < e; ++n)
                yc(r, (i = Iu[n])[0]) || yc(r, i[1]) ? (vc(r[0], i[1]) > vc(r[0], r[1]) && (r[1] = i[1]),
                vc(i[0], r[1]) > vc(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (a = -1 / 0,
            n = 0,
        ...
        return Iu = ju = null,
        Du === 1 / 0 || qu === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Du, qu], [Lu, Uu]]
    }
    ,
    t.geoCentroid = function(t) {
        ...
        e = Vu,
        r = $u),
        (i = n * n + e * e + r * r) < Ya) ? [NaN, NaN] : [Wa(e, n) * Xa, au(r / ru(i)) * Xa]
    }
    ,
    t.geoCircle = function() {
        ...
        return a.center = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Ec([+t[0], +t[1]]),
            a) : e
        }
        ,
        a.radius = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Ec(+t),
            a) : r
        }
        ,
        a.precision = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Ec(+t),
            a) : i
        }
        ,
        a
    ...
    t.geoAlbersUsa = function() {
        ...
        s.translate = function(t) {
            ...
            r = u.translate([o - .307 * n, s + .201 * n]).clipExtent([[o - .425 * n + Ba, s + .12 * n + Ba], [o - .214 * n - Ba, s + .234 * n - Ba]]).stream(f),
            i = c.translate([o - .205 * n, s + .212 * n]).clipExtent([[o - .214 * n + Ba, s + .166 * n + Ba], [o - .115 * n - Ba, s + .234 * n - Ba]]).stream(f),
            l()
        }
        ,
    ...
    t.geoIdentity = function() {
        ...
        return o = {
            ...
            clipExtent: function(r) {
                ...
                Af) : tf(h = +r[0][0], t = +r[0][1], n = +r[1][0], e = +r[1][1]),
                p()) : null == h ? null : [[h, t], [n, e]]
            },
            scale: function(t) {
                return arguments.length ? (l = il((a = +t) * f, a * s, u, c),
                p()) : a
            },
            translate: function(t) {
                return arguments.length ? (l = il(a * f, a * s, u = +t[0], c = +t[1]),
                p()) : [u, c]
            },
            reflectX: function(t) {
                return arguments.length ? (l = il(a * (f = t ? -1 : 1), a * s, u, c),
                p()) : f < 0
            },
            reflectY: function(t) {
                return arguments.length ? (l = il(a * f, a * (s = t ? -1 : 1), u, c),
                p()) : s < 0
            },
    ...
    t.pack = function() {
        ...
        function i(i) {
            return i.x = n / 2,
            i.y = e / 2,
            t ? i.eachBefore(Ll(t)).eachAfter(Ul(r, .5)).eachBefore(Ol(1)) : i.eachBefore(Ll(ql)).eachAfter(Ul(Rl, 1)).eachAfter(Ul(r, i.r / Math.min(n, e))).eachBefore(Ol(Math.min(n, e) / (2 * i.r))),
            i
        }
        return i.radius = function(n) {
            return arguments.length ? (t = null == (e = n) ? null : zl(e),
            i) : t;
            var e
        }
        ,
        ...
        i.padding = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Dl(+t),
            i) : r
        }
        ,
        i
    ...
    t.stratify = function() {
        ...
        function e(e) {
            ...
            for (i = 0; i < s; ++i)
                r = e[i],
                u = l[i] = new yl(r),
                null != (c = t(r, i, e)) && (c += "") && (h[f = Fl + (u.id = c)] = f in h ? jl : u);
            for (i = 0; i < s; ++i)
                if (u = l[i],
                null != (c = n(e[i], i, e)) && (c += "")) {
                    if (!(a = h[Fl + c]))
        ...
        return e.id = function(n) {
            return arguments.length ? (t = zl(n),
            e) : t
        }
        ,
        e.parentId = function(t) {
            return arguments.length ? (n = zl(t),
            e) : n
        }
        ,
        e
    ...
    t.tree = function() {
                ...
                for (var n, e, r, i, o, a = new Ql(t,0), u = [a]; n = u.pop(); )
                    if (r = n._.children)
                        ...
                        i = o - 1; i >= 0; --i)
                            ...
                            e.parent = n;
                return (a.parent = new Ql(null,0)).children = [a],
                a
            }(i);
            if (c.eachAfter(o),
            c.parent.m = -c.z,
        ...
        function o(n) {
            ...
            n.parent.A = function(n, e, r) {
                if (e) {
                    for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = $l(u),
                    o = Vl(o),
                    u && o; )
                        c = Vl(c),
                        (a = $l(a)).a = n,
                        (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (Wl(Zl(u, n, r), n, i),
                        f += i,
                        s += i),
                        l += u.m,
                        f += o.m,
    ...
    t.treemap = function() {
        ...
        s.paddingInner = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : Dl(+t),
            s) : o
        }
        ,
        ...
        s.paddingTop = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : Dl(+t),
            s) : a
        }
        ,
        s.paddingRight = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : Dl(+t),
            s) : u
        }
        ,
        s.paddingBottom = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : Dl(+t),
            s) : c
        }
        ,
        s.paddingLeft = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : Dl(+t),
            s) : f
        }
        ,
        s
    ...
    t.scaleIdentity = function t(n) {
        ...
        r.domain = r.range = function(t) {
            return arguments.length ? (n = vh.call(t, mh),
            r) : n.slice()
        }
        ,
    ...
    t.scaleQuantile = function t() {
        ...
        ,
        c.range = function(t) {
            return arguments.length ? (o = gh.call(t),
            u()) : o.slice()
        }
        ,
    ...
    t.scaleQuantize = function t() {
        ...
        ,
        c.range = function(t) {
            return arguments.length ? (o = (u = gh.call(t)).length - 1,
            f()) : u.slice()
        }
        ,
    ...
    t.scaleThreshold = function t() {
        ...
        ,
        a.range = function(t) {
            return arguments.length ? (r = gh.call(t),
            o = Math.min(e.length, r.length - 1),
            a) : r.slice()
        }
        ,
    ...
    t.arc = function() {
        ...
        function c() {
            ...
            h > fy)
                if (v > hy - fy)
                    ...
                    N > fy ? E > fy ? (y = by(B, Y, z, R, h, E, g),
                    _ = by(U, O, D, q, h, E, g),
                    u.moveTo(y.cx + y.x01, y.cy + y.y01),
                    E < S ? u.arc(y.cx, y.cy, E, ry(y.y01, y.x01), ry(_.y01, _.x01), !g) : (u.arc(y.cx, y.cy, E, ry(y.y01, y.x01), ry(y.y11, y.x11), !g),
                    u.arc(0, 0, h, ry(y.cy + y.y11, y.cx + y.x11), ry(_.cy + _.y11, _.cx + _.x11), !g),
                    u.arc(_.cx, _.cy, E, ry(_.y11, _.x11), ry(_.y01, _.x01), !g))) : (u.moveTo(z, R),
                    u.arc(0, 0, h, b, m, !g)) : u.moveTo(z, R),
                    l > fy && M > fy ? k > fy ? (y = by(D, q, U, O, l, -k, g),
                    _ = by(z, R, B, Y, l, -k, g),
                    u.lineTo(y.cx + y.x01, y.cy + y.y01),
                    k < S ? u.arc(y.cx, y.cy, k, ry(y.y01, y.x01), ry(_.y01, _.x01), !g) : (u.arc(y.cx, y.cy, k, ry(y.y01, y.x01), ry(y.y11, y.x11), !g),
                    u.arc(0, 0, l, ry(y.cy + y.y11, y.cx + y.x11), ry(_.cy + _.y11, _.cx + _.x11), g),
                    u.arc(_.cx, _.cy, k, ry(_.y11, _.x11), ry(_.y01, _.x01), !g))) : u.arc(0, 0, l, w, x, g) : u.lineTo(D, q)
                }
            else
                u.moveTo(0, 0);
            if (u.closePath(),
        ...
        c.endAngle = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : ny(+t),
            c) : o
        }
        ,
        c.padAngle = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : ny(+t),
            c) : a
        }
        ,
        c.context = function(t) {
    ...
    t.stack = function() {
        ...
        return i.keys = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : ny(qy.call(n)),
            i) : t
        }
        ,
        i.value = function(t) {
        ...
        ,
        i.order = function(t) {
            return arguments.length ? (n = null == t ? O_ : "function" == typeof t ? t : ny(qy.call(t)),
            i) : n
        }
        ,
        i.offset = function(t) {
            return arguments.length ? (e = null == t ? U_ : t,
            i) : e
        }
        ,
        i
    ...
    t.voronoi = function() {
        ...
        ,
        r.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : H_(+n),
            r) : t
        }
        ,
        r.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : H_(+t),
            r) : n
        }
        ,
        r.extent = function(t) {
    ...
    t.zoom = function() {
        ...
        y.wheelDelta = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : Sb(+t),
            y) : a
        }
        ,
        y.filter = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Sb(!!t),
            y) : r
        }
        ,
        y.touchable = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : Sb(!!t),
            y) : u
        }
        ,
        y.extent = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Sb([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            y) : i
        }
        ,
