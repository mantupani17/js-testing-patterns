var saveAs = saveAs || "undefined" != typeof navigator && navigator.msSaveOrOpenBlob && navigator.msSaveOrOpenBlob.bind(navigator) || function(e) {
    ...
    if ("undefined" == typeof navigator || !/MSIE [1-9]\./.test(navigator.userAgent)) {
        var t = e.document
          ...
          , d = e.requestFileSystem || a || e.mozRequestFileSystem
          , s = function(t) {
          ...
          , w = function(t, s) {
            var f, w, p, y = this, m = t.type, h = !1, g = function() {
                ...
                (h || !f) && (f = g(t)),
                w ? w.location.href = f : window.open(f, "_blank"),
                y.readyState = y.DONE,
                S()
            }, E = function(e) {
                return function() {
            ...
            i(o),
            y.readyState = y.DONE,
            void S()) : (e.chrome && m && m !== u && (p = t.slice || t.webkitSlice,
            t = p.call(t, 0, t.size, u),
            h = !0),
            a && "download" !== s && (s += ".download"),
            (m === u || a) && (w = e),
            d ? (c += t.size,
            void d(e.TEMPORARY, c, E(function(e) {
                e.root.getDirectory("saved", O, E(function(e) {
                    var n = function() {
                        e.getFile(s, O, E(function(e) {
        ...
        y.unload = function() {
            f(),
            e.removeEventListener("unload", f, !1)
        }
        ,
        y
    }
...
String.prototype.endsWithAny = function() {
    for (var e = Array.prototype.slice.call(arguments), t = this.toLowerCase().toString(), n = 0; n < e.length; n++)
        if (-1 !== t.indexOf(e[n], t.length - e[n].length))
            return !0;
    return !1
}
;
var saveTextAs = saveTextAs || function(e, t, n) {
    if (t = t || "download.txt",
    n = n || "utf-8",
    e = (e || "").replace(/\r?\n/g, "\r\n"),
    saveAs && Blob) {
        var o = new Blob([e],{
            type: "text/plain;charset=" + n
        });
        return saveAs(o, t),
        !0
    }
    var r = window.frames.saveTxtWindow;
    if (!r && (r = document.createElement("iframe"),
    r.id = "saveTxtWindow",
    r.style.display = "none",
    document.body.insertBefore(r, null),
    r = window.frames.saveTxtWindow,
    !r && (r = window.open("", "_temp", "width=100,height=100"),
    !r)))
        return window.alert("Sorry, download file could not be created."),
        !1;
    var i = r.document;
    i.open("text/plain", "replace"),
    i.charset = n,
    t.endsWithAny(".htm", ".html") ? (i.close(),
    i.body.innerHTML = "\r\n" + e + "\r\n") : (t.endsWithAny(".txt") || (t += ".txt"),
    i.write(e),
    i.close());
